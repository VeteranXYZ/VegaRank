...
export const manualEnglishScannerCodeEntries = {
  ...
  AC_001: {
    label: "Low Priority",
    short: "The row does not warrant research priority in the current VegaRank read.",
  },
  AC_101: {
    label: "Watch",
  ...
  AC_201: {
    label: "Manual Review",
    short: "Review the VegaRank evidence manually because context is mixed.",
  },
  AC_301: {
    label: "Avoid Chasing",
  ...
  MO_303: {
    ...
    short: "MACD evidence is weak enough to weigh on the VegaRank read.",
  },
  MO_304: {
  ...
  VO_001: {
    ...
    short: "Volatility context is normal and does not dominate the VegaRank read.",
  },
  VO_101: {
  ...
  VL_001: {
    ...
    short: "Trading activity is near average and does not dominate the VegaRank read.",
  },
  VL_101: {
  ...
  VL_601: {
    ...
    short: "Participation supports the constructive VegaRank read.",
  },
  VL_602: {
  ...
  RK_201: {
    ...
    short: "One or more risk constraints are present in the VegaRank read.",
  },
  RK_202: {
  ...
  ST_501: {
    ...
    short: "Pullback structure remains constructive by VegaRank criteria.",
  },
  ST_502: {
  ...
  QH_001: {
    ...
    short: "Data quality is sufficient for normal VegaRank display.",
  },
  QH_101: {
    label: "Low Quality",
  ...
  QH_201: {
    label: "Insufficient History",
    short: "History depth is too limited for a reliable normal VegaRank read.",
  },
  QH_202: {
    label: "New Listing",
  ...
  QH_402: {
    ...
    short: "Data quality constraints are too severe for a reliable VegaRank read.",
  },
  QH_501: {
    label: "Major Quality",
    short: "The symbol has stronger market quality for VegaRank research.",
  },
  QH_601: {
    label: "Core Quality",
  ...
  NX_001: {
    ...
    short: "VegaRank does not show enough evidence for a stronger research bucket.",
  },
  NX_101: {
  ...
  NX_201: {
    label: "Caution",
    short: "The VegaRank read needs more confirmation before priority rises.",
  },
  NX_302: {
  ...
  NX_801: {
    label: "Unknown Code",
    short: "No explanation is available for this VegaRank code yet.",
  },
